...
class EFAwsResolver(object):
        ...
        while True:
            ...
            if hosted_zones["IsTruncated"]:
                hosted_zones = EFAwsResolver.__CLIENTS["route53"].list_hosted_zones_by_name(
                    DNSName=hosted_zones["NextDNSName"], HostedZoneId=hosted_zones["NextHostedZoneId"],
                    MaxItems=list_limit)
            else:
                return default
    ...
    def cloudfront_domain_name(self, lookup, default=None):
        ...
        list_limit = "100"
        distributions = EFAwsResolver.__CLIENTS["cloudfront"].list_distributions(MaxItems=list_limit)[
            "DistributionList"]
