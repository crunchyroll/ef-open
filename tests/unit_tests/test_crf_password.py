...
class TestCRFPassword(unittest.TestCase):
  def setUp(self):
  ...
  def test_generate_secret(self):
    ...
    random_secret = crf_password.generate_secret(24)
  ...
  def test_args_decrypt(self):
    ...
    context = crf_password.handle_args_and_set_context(args)
  ...
  def test_args_plaintext_escape_sequences(self):
    ...
    When called from bash in this form `crf-password --plaintext "hello\nworld"`
  ...
  def test_args_invalid_env(self):
    ...
    with self.assertRaises(SystemExit):
      crf_password.handle_args_and_set_context(args)
  ...
  @patch('crf_password.generate_secret', return_value="mock_secret")
  @patch('crf_utils.create_aws_clients')
  @patch('crf_password.handle_args_and_set_context')
  def test_main(self, mock_context, mock_create_aws, mock_gen):
    ...
    context = crf_password.CRFPWContext()
  ...
  @patch('crf_password.generate_secret')
  @patch('crf_utils.create_aws_clients')
  @patch('crf_password.handle_args_and_set_context')
  ...
  @patch('crf_password.generate_secret_file')
  @patch('crf_utils.create_aws_clients')
  @patch('crf_password.handle_args_and_set_context')
