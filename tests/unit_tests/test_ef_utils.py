...
class TestEFUtils(unittest.TestCase):
  ...
  def test_get_parameters_for_template_file(self):
    ...
    test_parameters = ef_utils.get_parameters_for_template_file(test_template)
    self.assertEquals(test_parameters, target_parameters)

  def test_get_parameters_for_template_s3(self):
    """Test method returns valid parameters file"""
    ...
    test_parameters = ef_utils.get_parameters_for_template_s3(test_template, mock_s3_resource)
    self.assertEquals(test_parameters, target_parameters)
